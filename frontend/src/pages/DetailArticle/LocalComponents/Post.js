...
const Post = () => {
	return (
		<div>
			<section>
				Jakarta, 13 Juli 2021 - Lorem Ipsum is simply dummy text of the printing and
				...
				including versions of Lorem Ipsum. It is a long established fact that a reader will
				...
				sometimes by accident, sometimes on purpose (injected humour and the like). Contrary

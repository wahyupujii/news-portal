						...
						<Card className='mb-4'>
							...
							<Card.Body>
								<Card.Text>
									...
									Dolorem possimus cumque quibusdam fugiat aliquid? Non ad
									quibusdam officiis. Aperiam, corporis!
								</Card.Text>
								...
								<Card style={{ marginLeft: '20px' }} className='mb-3'>
									...
									<Card.Body>
										<Card.Text>
											...
											elit. Dolorem possimus cumque quibusdam fugiat aliquid?
											Non ad quibusdam officiis. Aperiam, corporis!
										</Card.Text>
									</Card.Body>
								</Card>

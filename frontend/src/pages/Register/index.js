                    ...
                    <Container className="w-75 h-100 d-flex justify-content-center align-items-center">
                        <Form style={{ width: '460px' }}>
                            <div className="text mb-4">
                                <h4 className="mb-3" style={{ fontSize: '48px' }}>Join Us!</h4>
                            </div>
                            ...
                            <InputGroup className="my-4">
                                <InputGroup.Text id="basic-addon2"><i className="fa fa-envelope"></i></InputGroup.Text>
                                <FormControl
                                    placeholder="Email"
                                    aria-label="Email"
                            ...
                            <InputGroup className="my-4">
                                <InputGroup.Text id="basic-addon3"><i className="fa fa-lock"></i></InputGroup.Text>
                                <FormControl
